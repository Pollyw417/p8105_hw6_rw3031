...
My assumption is that child birthweight is going to be associated with gestational age in weeks, and covariates for the model involve mother's age at delivery, mother's race, family monthly income, average number of cigarettes smoked per day during pregnancy. 

```{r}
fit_bw = lm(bwt ~ gaweeks+momage+mrace+fincome+smoken, data=birthweight)
...
Based on the model output, mother's age at develiry and family income has a p-value greater than 0.05 thus are not signficant covariates. I removed those two variables and refit the model. 
